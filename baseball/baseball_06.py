...
while True:
    ...
    if guess_numbers[0] == guess_numbers[1] or guess_numbers[0] == guess_numbers[2] or guess_numbers[1] == guess_numbers[2]:
    ...
    if guess_numbers[0] == numbers[0] and guess_numbers[1] == numbers[1] and guess_numbers[2] == numbers[2]:
        print("정답입니다.")
        break
